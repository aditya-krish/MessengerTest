...
PerlACE::add_lib_path("/home/agilehealth_ai/MiscellaneousScripts/openDDS_test/messenger_idl");
#PerlACE::add_lib_path("$DDS_ROOT/tests/DCPS/Messenger");

my $PUB = new PerlDDS::Process_Java('publisher.TestPublisher', $pub_opts,
            ["/home/agilehealth_ai/MiscellaneousScripts/openDDS_test/messenger_idl".

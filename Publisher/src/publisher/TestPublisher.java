...
public class TestPublisher {
	...
	public static void main(String[] args) {
        ...
        //------------------------- initializing the domain participant ------------------------
        ...
        if (dp == null) {
        	System.err.println("ERROR: Domain participalnt creation failed.");
        }
        ...
        msg.subject = "Review";
        msg.text = "My review of Last Year in Marienbad.";
        msg.count = 0;
    	...
    	if (waitForAcks) {
    		System.out.println("Publisher waiting for acknowledgement");
    		
    		// wait for acknowledgements
    		Duration_t forever = new Duration_t(
            		DURATION_INFINITE_SEC.value,
            		DURATION_INFINITE_NSEC.value);
